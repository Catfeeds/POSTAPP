                    ...
                    <div class="row">
                        <div class="col-sm-12 m-b-xs">
                            <div class="input-group">
                                <input class="form-control" name="keyword" id="" type="text" value="<?php  echo $_GPC['keyword'];?>" placeholder="关键字">
        ...
        <form action="" class="form-horizontal form" method="post" enctype="multipart/form-data">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><?php  echo $item['total_spaces'];?></td>
                    <td><?php  echo $item['remain_spaces'];?></td>
