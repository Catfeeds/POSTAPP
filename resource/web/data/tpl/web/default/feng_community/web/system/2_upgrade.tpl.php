...
<div class="panel">
	...
	<form action="" method="post" class="form-horizontal" role="form">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<p class="form-control-static"><span class="fa fa-square-o"></span> &nbsp; 系统当前版本: v <?php  echo $version;?> Build <?php  echo $release;?></p>
				<?php  if(!empty($upgrade['version'])) { ?>
				<p class="form-control-static"><span class="fa fa-square-o"></span> &nbsp; 存在的新版本: v <?php  echo $upgrade['version'];?> Build <?php  echo $upgrade['release'];?></p>
				<?php  } ?>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				...
				<div class="alert alert-info" style="line-height:20px;margin-top:20px;">
					...
					<div><span style="display:inline-block; width:30px;"><?php  if(is_file($line['entry'])) { ?>M<?php  } else { ?>A<?php  } ?></span><?php  echo $line['path'];?></div>
					<?php  } } ?>
				</div>
			</div>
		</div>
