...
<ul class="nav nav-tabs">
    <li class="active"><a href="<?php  echo $this->createWebUrl('repair', array('op' => 'list'));?>">报修管理</a>
    </li>

    <li><a href="<?php  echo $this->createWebUrl('category', array('op'=>'list','type' => 2));?>">服务分类</a></li>

    <li><a href="<?php  echo $this->createWebUrl('repair', array('op'=>'manage','operation' => 'add'));?>">管理接收员</a></li>
</ul>
        ...
        <table class="table table-hover">
            ...
            <tr>
                ...
                <td>
                    ...
                    <span class="label label-info">受理中</span>
                    <?php  } ?>
                    <?php  if($item['status'] == 2 ) { ?>
                    <span class="label label-default">未处理</span><?php  } ?>
                </td>
                <td>
