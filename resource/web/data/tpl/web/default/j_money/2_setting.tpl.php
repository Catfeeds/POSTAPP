      ...
      <div class="panel-body" >
        ...
        <div class="tab-content">
		  ...
		  <div class="tab-pane" id="tab10">
      		   <div class="form-group">
              <label class="col-xs-12 col-sm-3 col-md-2 control-label">是否开启POS刷卡功能</label>
              <div class="col-sm-9">
                <label class="radio-inline">
                  <input type="radio" name="card_pay_switch" value="0" <?php  if($item['card_pay_switch'] == 0) { ?> checked<?php  } ?> />
                  关闭</label>
                <label class="radio-inline">
                  <input type="radio" name="card_pay_switch" value="1" <?php  if($item['card_pay_switch'] == 1) { ?> checked<?php  } ?> />
                  开启</label>
              </div>
            </div>
		  </div>
