    ...
    <div class="card">
        ...
        <div class="card-content">
            <div class="list-block media-list">
                <ul>
                    <?php  if(is_array($qhregions)) { foreach($qhregions as $region) { ?>
                    <li class="item-content" onclick="change(<?php  echo $region['id'];?>)">
                        <?php  if($region['thumb']) { ?>
                        ...
                        <div class="item-inner">
                            ...
                            <div class="item-subtitle" style="font-size: 12px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;width:200px;"><?php  echo $region['dist'];?><?php  echo $region['address'];?></div>
                        </div>
                        <?php  if($region['enable']) { ?>
