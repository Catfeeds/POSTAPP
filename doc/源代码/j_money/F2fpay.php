...
class F2fpay {
	...
	public function barpay($out_trade_no, $auth_code, $total_amount, $subject,$config) {
	   // $config['sys_service_provider_id']='2088721109731155';
	   //$config['sys_service_provider_id']
		...
		if($config['sys_service_provider_id'] && $config['sys_service_provider_id']!="")
		    $biz_content.="\"extend_params\":{\"sys_service_provider_id\":\"".$config['sys_service_provider_id']."\"},";
		$biz_content.="\"timeout_express\":\"1m\"}";
